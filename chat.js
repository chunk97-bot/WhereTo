...
class TravelChatbot {
    ...
    addMessage(content, sender) {
        ...
        const novaAvatar = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="novaMsgGrad${Date.now()}" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#00f5ff"/><stop offset="50%" style="stop-color:#8b5cf6"/><stop offset="100%" style="stop-color:#ec4899"/></linearGradient></defs><rect x="4" y="7" width="16" height="13" rx="4" fill="url(#novaMsgGrad${Date.now()})"/><rect x="7" y="3" width="10" height="5" rx="2.5" fill="url(#novaMsgGrad${Date.now()})"/><circle cx="8.5" cy="12.5" r="2.5" fill="#0a0a1a"/><circle cx="15.5" cy="12.5" r="2.5" fill="#0a0a1a"/><circle cx="8.5" cy="12.5" r="1.5" fill="#00f5ff"/><circle cx="15.5" cy="12.5" r="1.5" fill="#00f5ff"/><rect x="10" y="16" width="4" height="2" rx="1" fill="#ec4899"/><rect x="11" y="0" width="2" height="4" rx="1" fill="url(#novaMsgGrad${Date.now()})"/><circle cx="12" cy="0" r="1.5" fill="#00f5ff"/><rect x="1" y="10" width="3" height="6" rx="1.5" fill="url(#novaMsgGrad${Date.now()})"/><rect x="20" y="10" width="3" height="6" rx="1.5" fill="url(#novaMsgGrad${Date.now()})"/></svg>`;
    ...
    showTyping() {
        ...
        const novaTypingAvatar = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="novaTypingGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#00f5ff"/><stop offset="50%" style="stop-color:#8b5cf6"/><stop offset="100%" style="stop-color:#ec4899"/></linearGradient></defs><rect x="4" y="7" width="16" height="13" rx="4" fill="url(#novaTypingGrad)"/><rect x="7" y="3" width="10" height="5" rx="2.5" fill="url(#novaTypingGrad)"/><circle cx="8.5" cy="12.5" r="2.5" fill="#0a0a1a"/><circle cx="15.5" cy="12.5" r="2.5" fill="#0a0a1a"/><circle cx="8.5" cy="12.5" r="1.5" fill="#00f5ff"/><circle cx="15.5" cy="12.5" r="1.5" fill="#00f5ff"/><rect x="10" y="16" width="4" height="2" rx="1" fill="#ec4899"/><rect x="11" y="0" width="2" height="4" rx="1" fill="url(#novaTypingGrad)"/><circle cx="12" cy="0" r="1.5" fill="#00f5ff"/><rect x="1" y="10" width="3" height="6" rx="1.5" fill="url(#novaTypingGrad)"/><rect x="20" y="10" width="3" height="6" rx="1.5" fill="url(#novaTypingGrad)"/></svg>`;
        typingDiv.innerHTML = `
